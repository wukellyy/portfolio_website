        ...
        <div className="w-[500px] h-auto p-8 flex flex-col  justify-center items-center bg-cream border-2 border-neutral-800 rounded-2xl m-2 shadow-lg">
          <div className="flex flex-col justify-center gap-2">
            <div className="flex items-center gap-3">
              <IoMdMail className="text-[40px] lg:text-[50px]" />
              <a
                href="mailto:kelly.wu@nyu.edu"
                className="font-semibold text-xl lg:text-2xl underline hover:text-neutral-600 transition"
              >
                kelly.wu@nyu.edu
              </a>
            </div>
            <div className="flex items-center gap-3">
              <FaLinkedin className="text-[40px] lg:text-[50px]" />
              <a
                href="https://linkedin.com/in/wukellyy"
                target="_blank"
                rel="noopener noreferrer"
                className="font-semibold text-xl lg:text-2xl hover:underline hover:text-neutral-600 transition"
              >
                linkedin.com/in/wukellyy
              </a>
            </div>
            <div className="flex items-center gap-3">
              <FaSquareGithub className="text-[40px] lg:text-[50px]" />
              <a
