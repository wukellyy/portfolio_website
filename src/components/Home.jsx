...
const Home = () => {
  return (
    <div className="w-full h-screen bg-cream">
      <div className="h-full px-8 flex flex-col justify-center items-center gap-6">
        <div>
          <img
        ...
        <div className="flex flex-col items-center gap-2">
          ...
          <div className="text-neutral-800 font-bold text-4xl">Kelly Wu</div>
          <div className="text-neutral-600 font-bold text-2xl">
